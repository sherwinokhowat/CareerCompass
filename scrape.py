...
async def process_job_listings(
    ...
    Note that the parameter 'jobs' is a list of 30 jobs and their information, retrieved from the GraphQL query.
    """
...
def fetch_jobs_us(cursor: str) -> dict | None:
    """
...
def fetch_jobs_ca(cursor: str) -> dict | None:
    """
    Returns a dictionary of 30 jobs with their generalized info.
...
if __name__ == "__main__":
    ...
    # 2. E9998 (Forbidden-IO-Function): Necessary as to communicate scraping status.
    # 3. C0301 (Line-Too-Long): Necessary to scrape all data we need.
    ...
    python_ta.check_all(config={
        'max-line-length': 120,
        'extra-imports': ["csv", "random", "requests", "time", "asyncio", "aiohttp", "json", "utility"],
